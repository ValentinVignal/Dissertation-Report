...
\begin{figure}
    ...
    \begin{tikzpicture}
        \pie[rotate=180]{
        58.5/With Scale and Rhythm losses,
        41.5/Without Scale and Rhythm losses
        }
    \end{tikzpicture}
...
The figure \ref{fig:pie:harmony} display the result of the preference of the persons who completed the survey.

\begin{figure}
    \begin{center}
    \begin{tikzpicture}
        \pie[rotate=180]{
        40.1/With Harmony loss,
        59.9/Without Harmony loss
        }
    \end{tikzpicture}
