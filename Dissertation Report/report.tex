...
These tasks are, generating one or several musical parts, generating an accompaniment from a melody, generating a melody from an accompaniment, generating one or several musical parts from one or several other musical parts.
...
The tasks I have implemented are, generate several musical parts, generate a musical part from other musical parts, and re-write a song by replacing one by one all the musical parts.
...
The accuracy of the model to generate the next measure is around $0.8$.
...
However they is no noticeable difference between the samples generated of the two models.
The figures \ref{fig:exp:tranpose:with} and \ref{fig:exp:tranpose:without} respectively show a sample generated by the model trained and transposed data and a sample generated by the model train on the non transposed data.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{images/experiences/transpose-rnn/generated-with-transpose.jpg}
    \caption{Pianoroll generated by the model which was trained on transposed data}
...
\begin{figure}[htbp]
    ...
    \caption{Pianoroll generated by the model which was trained on non transposed data}
...
% TODO: Put results of the google forms for transpose
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \pie[rotate=180]{
        56.7/With transposed data,
        43.3/Without transposed data
        }
    \end{tikzpicture}
    \caption{\href{https://docs.google.com/forms/d/e/1FAIpQLSe3LEiDZFI9Y58OgWvHwKke4k1_2yPg8eJLQFBasSKUAdh3Ng/viewform?usp=sf_link}{Google Form} result on model size}
    The preferred model by the people
    \label{fig:pie:transpose}
    \end{center}
\end{figure}

Only 3 persons answered the survey.
There is no enough data to conclude anything.
...
29 persons answered the google form, and surprisingly, the results follow the metrics even though the generated samples are pretty similar.
...
% TODO: Put results of the google forms for scale and rhythm
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \pie[rotate=180]{
        58/With Scale and Rhythm losses,
        42/Without Scale and Rhythm losses
        }
    \end{tikzpicture}
...
15 persons answered the google form.
...
% TODO: Put results of the google forms for harmony
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \pie[rotate=180]{
        42/With Harmony loss,
        58/Without Harmony loss
        }
    \end{tikzpicture}
...
21 persons answered the google form.
...
% TODO: Update the poll for RPoE

\begin{figure}
    \begin{center}
    \begin{tikzpicture}
        \pie[rotate=180]{
        49.1/With RPoE layer,
        50.9/Without RPoE layer
        }
    \end{tikzpicture}
