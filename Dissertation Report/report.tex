...
The graph of this section are in the appendix \ref{appendix:size}.
...
The appendix \ref{appendix:scale-rhythm} contains useful graph for this section.
...
Both of the trained models here are using the accuracy loss.
...
It would mean the scale and rhythm losses are independent from the harmony loss.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \pie[rotate=180]{
        65/With Scale and Rhythm losses,
        35/Without Scale and Rhythm losses
        }
    \end{tikzpicture}
    \caption{Google form result on Scale and Rhythm losses}
    The preferred model by the people
    \label{fig:pie:scale-loss}
    \end{center}
\end{figure}

2 persons answered the google form.
And in that case, the result of the survey doesn't match the metrics but match my feeling about the generated samples.
People preferred the samples generated by the model with the scale and rhythm losses.
...
\end{itemize}
The appendix \ref{appendix:harmony} contains useful graph for this section.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \pie[rotate=180]{
        35.2/With Harmony loss,
        64.8/Without Harmony loss
        }
    \end{tikzpicture}
...
This section contains the plots of the different experiments
