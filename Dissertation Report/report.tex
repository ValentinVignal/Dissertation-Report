...
17 persons answered the google form, and surprisingly, the results follow the metrics even though the generated samples are pretty similar.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \pie[rotate=180]{
        14.8/With Harmony loss,
        85.2/Without Harmony loss
        }
    \end{tikzpicture}
...
7 persons answered the google form, and surprisingly, unfortunately, the people have preferred the model which doesn't use the harmony loss.
