...
By lack of time and result, I haven't been able to create many polls to evaluate the musical samples my model generates.
...
However there is no noticeable difference between the samples generated of the two models.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \pie[rotate=180]{
        48.5/With RPoE layer,
        51.5/Without RPoE layer
        }
    \end{tikzpicture}
...
13 persons answered the google form.
